...
<a href="https://docs.int.bayer.com/-/ocs.sas2r/"><img class="cover" src="content/title2.png" width="310" height="310" align = "left" HSPACE="30"></a>    The intent of this resource is to act as a knowledge hub for using R in a clinical study context. 
...
If you would suggest any content be added or amended, or have questions or feedback, we kindly request that you [open an issue](https://github.com/bayer-int/ocs.sas2r/issues). The current maintainer is [Siqi Zhang](https://github.com/iqis).