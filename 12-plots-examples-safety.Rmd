...
Recently, the FDA has published a document for a more [standardized presentation of safety data](https://downloads.regulations.gov/FDA-2022-N-1961-0002/attachment_1.pdf). The [falcon](https://github.com/pharmaverse/falcon) package aims to cover all tables and plots eventually. However, similar visualisation might be of interest also outside of this package. This is why we provide some code here to show how to combine a plot and a table using the *patchwork* package. 
